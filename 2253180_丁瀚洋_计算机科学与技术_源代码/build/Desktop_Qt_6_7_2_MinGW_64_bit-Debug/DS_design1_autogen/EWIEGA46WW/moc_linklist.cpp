...
constexpr auto qt_meta_stringdata_CLASSLinkListENDCLASS = QtMocHelpers::stringData(
    "LinkList",
    "update",
    ""
);
...
void LinkList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LinkList::*)();
            if (_t _q_method = &LinkList::update; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
