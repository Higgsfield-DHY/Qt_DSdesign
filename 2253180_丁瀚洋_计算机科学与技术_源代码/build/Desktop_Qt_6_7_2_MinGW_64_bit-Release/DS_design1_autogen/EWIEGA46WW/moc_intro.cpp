...
Q_CONSTINIT const QMetaObject Intro::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSIntroENDCLASS_t,
        ...
        // method 'on_RtnMemuButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Intro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->intro_back(); break;
        case 1: _t->on_RtnMemuButton_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Intro::*)();
            if (_t _q_method = &Intro::intro_back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
